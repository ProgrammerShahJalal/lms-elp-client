...
import { useGetMyShippingAddressQuery, useUpdateShippingAddressMutation } from "@/redux/api/usersApi";
  ...
  const onHandleSubmit = async (e) => {
    ...
    try {
       const res = await updateUser({
        id, address, billing_name, contact_no, district, division, upazilla
       });
       if(res){
