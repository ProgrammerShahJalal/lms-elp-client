  ...
  if (!isLoading && !isError && data) {
    ...
    <div>
      <div className="space-y-4 mb-10">
        ...
        <p >Sub Category: <span className=" text-yellowPrimary">{data?.sub_category_id?.name}</span >  <span className=" text-bluePrimary pl-10 font-semibold"> Category: {data?.sub_category_id?.category_id?.name} </span></p>
        <Image
          className="rounded"
