    ...
    <div className="lg:px-14 py-10 px-3 rounded shadow-current">
      <div className="px-14 ">
        <div className="space-y-4">
          ...
          <Link href="/basicQuiz">
            <button className="flex items-center gap-3 bg-greenPrimary text-white ease-out duration-500 transition-all hover:bg-cyanPrimary cursor-pointer px-6 py-3 rounded "> কুইজ শুরু করুন</button>
          </Link>
