  ...
  return (
    ...
    <div className='py-10 text-center text-white'> 
       ...
       <Link href="/courses" className="bg-cyanPrimary text-white py-2 px-4 transition-all duration-300 rounded hover:bg-transparent hover:border border-cyan-900">সবগুলো কোর্স দেখুন </Link>
        ...
        <a href="https://forms.gle/3vjsXVuQi2vUomHX7" className="bg-yellowPrimary text-white py-2 px-4 transition-all duration-300 rounded hover:bg-cyanPrimary md: mt-5" target="_blank"> কল বক করুন</a>
