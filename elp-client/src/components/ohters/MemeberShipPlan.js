       ...
       <div className="container mx-auto my-10">
          ...
          <div className=" bg-white rounded">
            ...
            <div  className="card svg-card text-center p-4 " >
              ...
              <div className="card-body">
                ...
                <a className="bg-bluePrimary text-white py-3 px-4 transition-all duration-300 rounded hover:bg-cyanPrimary " href="/">Buy Now</a>
              </div>
        ...
        <div  className="card svg-card text-center p-4 " >
          ...
          <div className="card-body">
            ...
            <p className="opacity-75 py-2">Support : yes</p>
            <a className="bg-yellowPrimary text-white py-3 px-4 transition-all duration-300 rounded hover:bg-cyanPrimary " href="/">Buy Now</a>
          </div>
          <div className="custom-shape-divider-bottom-1645939714">
            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
          ...
          <div className="bg-white rounded">
            ...
            <div  className="card svg-card text-center p-4 " >
              ...
              <div className="card-body">
                ...
                <p className="opacity-75 py-2">Support : yes</p>
                <a className="bg-cyanPrimary text-white py-3 px-4 transition-all duration-300 rounded hover:bg-bluePrimary " href="/">Buy Now</a>
              </div>
              <div className="custom-shape-divider-bottom-1645939714">
                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                    <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
