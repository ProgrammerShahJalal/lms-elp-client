...
//                     <h1 className="text-xl font-semibold">You Got Mark : {item.total_correct_answer}</h1>
...
//                                 {answer?.options?.map((option, optionIndex) => {
//                                     const isChecked = Object.values(answer?.answer).includes(option);
//                                     const isCorrectAnswer = Object.keys(answer?.answer).find(key => answer.answer[key] === item.correct_answer);
//                                     return (
//                                         <li key={optionIndex}>
//                                             <label className="flex items-center space-x-2">
//                                                 <input
//                                                     type="radio"
//                                                     className={` ${isCorrectAnswer === 'b' ? 'text-green-500' : 'text-red-500'}`}
//                                                     name={`question${answerIndex}`}
//                                                     value={option}
//                                                     checked={isChecked}
//                                                 />
